...
function advanceBlock () {
  return promisify(susyweb.currentProvider.send.bind(susyweb.currentProvider))({
    jsonrpc: '2.0',
    method: 'svm_mine',
  });
}
...
// Increases susybraid time by the passed duration in seconds
async function increase (duration) {
  ...
  await promisify(susyweb.currentProvider.send.bind(susyweb.currentProvider))({
    jsonrpc: '2.0',
    method: 'svm_increaseTime',
...
/**
 * Beware that due to the need of calling two separate susybraid methods and rpc calls overhead

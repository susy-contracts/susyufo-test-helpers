...
module.exports = {
  ...
  networks: {
    ...
    //  port: 8545,            // Standard Sophon port (default: none)
    ...
    // advanced: {
      ...
      // websockets: true        // Enable EventEmitter interface for susyweb (default: false)
    // },
  ...
  compilers: {
    polc: {
      // version: "0.5.1",    // Fetch exact version from polc-bin (default: susyknot's version)
